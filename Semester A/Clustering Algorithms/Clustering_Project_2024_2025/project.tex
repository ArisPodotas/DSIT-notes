...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/PCA result.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/Salinas truth.png}
    \end{center}
...
We actually already know the number of clusters that should be found from the project description. We will however still try a $9$ clustering of the data despite the $8$ ground truth labels. %Out of interest we will look at some of the methods we have for determining the number of clusters to see if the results line up with the a-priori knowledge.
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/Time trials.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/k-means.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/Fuzzy c-means.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/Possibilistic c-means.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/Probabilistic c-means.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \begin{tabular}{cc}
            \subfloat[Clusters]{\includegraphics[width=0.45\textwidth]{./Images/Single link.png}} &
            \subfloat[Dendrogram]{\includegraphics[width=0.45\textwidth]{./Images/Single link tree.png}} 
        \end{tabular}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \begin{tabular}{cc}
            \subfloat[Clusters]{\includegraphics[width=0.45\textwidth]{./Images/Complete link.png}} &
            \subfloat[Dendrogram]{\includegraphics[width=0.45\textwidth]{./Images/Complete link tree.png}} 
        \end{tabular}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \begin{tabular}{cc}
            \subfloat[Clusters]{\includegraphics[width=0.45\textwidth]{./Images/WPGMC.png}} &
            \subfloat[Dendrogram]{\includegraphics[width=0.45\textwidth]{./Images/WPGMC tree.png}} 
        \end{tabular}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \begin{tabular}{cc}
            \subfloat[Clusters]{\includegraphics[width=0.45\textwidth]{./Images/Ward.png}} &
            \subfloat[Dendrogram]{\includegraphics[width=0.45\textwidth]{./Images/Ward tree.png}} 
        \end{tabular}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/warning.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/error.png}
    \end{center}
...
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/k-means 9.png}
    \end{center}
    \caption{Result of k-means algorithm (9 clustering)}\label{fig:means2}
\end{figure}

% pos
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/Possibilistic c-means 9.png}
    \end{center}
    \caption{Result of Possibilistic c-means algorithm (9 clustering)}\label{fig:pos2}
\end{figure}

% prob
\begin{figure}[H]
    \begin{center}
        \includegraphics[width=0.95\textwidth]{./Images/Probabilistic c-means 9.png}
    \end{center}
    \caption{Result of Probabilistic c-means algorithm (9 clustering)}\label{fig:prob2}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \begin{tabular}{cc}
            \subfloat[Clusters]{\includegraphics[width=0.45\textwidth]{./Images/Single link 9.png}} &
            \subfloat[Dendrogram]{\includegraphics[width=0.45\textwidth]{./Images/Single link tree 9.png}} 
        \end{tabular}
    \end{center}
    \caption{Result of the Single link algorithm (9 clustering)}\label{fig:sing2}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \begin{tabular}{cc}
            \subfloat[Clusters]{\includegraphics[width=0.45\textwidth]{./Images/Complete link 9.png}} &
            \subfloat[Dendrogram]{\includegraphics[width=0.45\textwidth]{./Images/Complete link tree 9.png}} 
        \end{tabular}
    \end{center}
    \caption{Result of the Complete link algorithm (9 clustering)}\label{fig:comp2}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \begin{tabular}{cc}
            \subfloat[Clusters]{\includegraphics[width=0.45\textwidth]{./Images/WPGMC 9.png}} &
            \subfloat[Dendrogram]{\includegraphics[width=0.45\textwidth]{./Images/WPGMC tree 9.png}} 
        \end{tabular}
    \end{center}
    \caption{Result of WPGMC algorithm (9 clustering)}\label{fig:wpgmc2}
\end{figure}
...
\begin{figure}[H]
    \begin{center}
        \begin{tabular}{cc}
            \subfloat[Clusters]{\includegraphics[width=0.45\textwidth]{./Images/Ward 9.png}} &
            \subfloat[Dendrogram]{\includegraphics[width=0.45\textwidth]{./Images/Ward tree 9.png}} 
        \end{tabular}
    \end{center}
    \caption{Result of Ward algorithms (9 clustering)}\label{fig:ward2}
\end{figure}
