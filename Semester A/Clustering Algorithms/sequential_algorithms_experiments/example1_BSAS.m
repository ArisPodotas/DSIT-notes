...
figure(2), plot(X(1,:),X(2,:),'.b', repre_2(1,:),repre_2(2,:),'*r')
figure(2), axis equal
'q, theta', [q, theta]
'order', order
pause;
...
figure(3), plot(X(1,:),X(2,:),'.b', repre_3(1,:),repre_3(2,:),'*r')
figure(3), axis equal
'q, theta', [q, theta]
'order', order
pause;
...
figure(4), plot(X(1,:),X(2,:),'.b', repre_4(1,:),repre_4(2,:),'*r')
figure(4), axis equal
'q, theta', [q, theta]
'order', order
pause;
...
figure(5), plot(X(1,:),X(2,:),'.b', repre_5(1,:),repre_5(2,:),'*r')
figure(5), axis equal
'q, theta', [q, theta]
'order', order
pause;
